# app.py — Versión solo para Mosquera (con filtro de grados)
# Streamlit 1.37.x
...
# --- Config de página ---
st.set_page_config(
    page_title="Reporte Institucional — Innova Schools Mosquera",
...
if TARGET_SEDE_DATASET is None:
    st.error("❌ No se encontró la sede 'Mosquera' en el archivo.")
    st.stop()

# --- Filtrar todo a Mosquera ---
...
with st.sidebar:
    ...
    if grados_disp:
        ...
        grado_opt = "Todos"
        st.caption("No hay grados 3/5/7/9 disponibles en Mosquera.")
